...
class AdvertisingDataApi
{
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDay
     *
     ...
     * @return string
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDay($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        list($response) = $this->getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayWithHttpInfo($organisation_uuids, $from_date, $date_format, $format);
        return $response;
    }

    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayWithHttpInfo
     *
     * Return adform extended report per organisation per campaign per creative per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $request = $this->getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayAsync
     *
     * Return adform extended report per organisation per campaign per creative per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayAsync($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        return $this->getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayAsyncWithHttpInfo($organisation_uuids, $from_date, $date_format, $format)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayAsyncWithHttpInfo
     *
     * Return adform extended report per organisation per campaign per creative per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayAsyncWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $returnType = 'string';
        $request = $this->getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Create request for operation 'getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDay'
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     * @param  \DateTime $from_date From date (optional)
     * @param  string $date_format Outputted date format (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDayRequest($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        // verify the required parameter 'organisation_uuids' is set
        if ($organisation_uuids === null || (is_array($organisation_uuids) && count($organisation_uuids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisation_uuids when calling getAdformExtendedReportPerOrganisationPerCampaignPerCreativePerDay'
            );
        }

        $resourcePath = '/data/adform-extended-report-per-organisation-per-campaign-per-creative-per-day/{organisationUuids}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDay
     *
     ...
     * @return string
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDay($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        list($response) = $this->getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayWithHttpInfo($organisation_uuids, $from_date, $date_format, $format);
        return $response;
    }

    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayWithHttpInfo
     *
     * Return adform extended report per organisation per campaign per line item per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $request = $this->getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayAsync
     *
     * Return adform extended report per organisation per campaign per line item per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayAsync($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        return $this->getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayAsyncWithHttpInfo($organisation_uuids, $from_date, $date_format, $format)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayAsyncWithHttpInfo
     *
     * Return adform extended report per organisation per campaign per line item per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayAsyncWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $returnType = 'string';
        $request = $this->getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Create request for operation 'getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDay'
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     * @param  \DateTime $from_date From date (optional)
     * @param  string $date_format Outputted date format (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDayRequest($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        // verify the required parameter 'organisation_uuids' is set
        if ($organisation_uuids === null || (is_array($organisation_uuids) && count($organisation_uuids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisation_uuids when calling getAdformExtendedReportPerOrganisationPerCampaignPerLineItemPerDay'
            );
        }

        $resourcePath = '/data/adform-extended-report-per-organisation-per-campaign-per-line-item-per-day/{organisationUuids}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
