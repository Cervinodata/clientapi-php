...
class AdvertisingDataApi
{
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerDay
     *
     ...
     * @return string
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerDay($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        list($response) = $this->getAdformExtendedReportPerOrganisationPerCampaignPerDayWithHttpInfo($organisation_uuids, $from_date, $date_format, $format);
        return $response;
    }

    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerDayWithHttpInfo
     *
     * Return adform extended report per organisation per campaign per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerDayWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $request = $this->getAdformExtendedReportPerOrganisationPerCampaignPerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerDayAsync
     *
     * Return adform extended report per organisation per campaign per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerDayAsync($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        return $this->getAdformExtendedReportPerOrganisationPerCampaignPerDayAsyncWithHttpInfo($organisation_uuids, $from_date, $date_format, $format)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAdformExtendedReportPerOrganisationPerCampaignPerDayAsyncWithHttpInfo
     *
     * Return adform extended report per organisation per campaign per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerDayAsyncWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $returnType = 'string';
        $request = $this->getAdformExtendedReportPerOrganisationPerCampaignPerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Create request for operation 'getAdformExtendedReportPerOrganisationPerCampaignPerDay'
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     * @param  \DateTime $from_date From date (optional)
     * @param  string $date_format Outputted date format (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAdformExtendedReportPerOrganisationPerCampaignPerDayRequest($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        // verify the required parameter 'organisation_uuids' is set
        if ($organisation_uuids === null || (is_array($organisation_uuids) && count($organisation_uuids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisation_uuids when calling getAdformExtendedReportPerOrganisationPerCampaignPerDay'
            );
        }

        $resourcePath = '/data/adform-extended-report-per-organisation-per-campaign-per-day/{organisationUuids}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
