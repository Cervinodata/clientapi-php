...
class AnalyticsDataGoalsApi
{
    ...
    /**
     * Operation getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay
     *
     ...
     * @return string
     */
    public function getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        list($response) = $this->getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayWithHttpInfo($organisation_uuids, $from_date, $date_format, $format);
        return $response;
    }

    /**
     * Operation getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayWithHttpInfo
     *
     * Return analytics goal report per device per channel group per organisation per view per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $request = $this->getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Operation getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayAsync
     *
     * Return analytics goal report per device per channel group per organisation per view per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayAsync($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        return $this->getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayAsyncWithHttpInfo($organisation_uuids, $from_date, $date_format, $format)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayAsyncWithHttpInfo
     *
     * Return analytics goal report per device per channel group per organisation per view per day
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayAsyncWithHttpInfo($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        $returnType = 'string';
        $request = $this->getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayRequest($organisation_uuids, $from_date, $date_format, $format);
    ...
    /**
     * Create request for operation 'getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay'
     *
     * @param  string[] $organisation_uuids Organisation uuids (required)
     * @param  \DateTime $from_date From date (optional)
     * @param  string $date_format Outputted date format (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayRequest($organisation_uuids, $from_date = null, $date_format = null, $format = null)
    {
        ...
        if ($organisation_uuids === null || (is_array($organisation_uuids) && count($organisation_uuids) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $organisation_uuids when calling getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay'
            );
        }

        $resourcePath = '/data/analytics-goal-report-per-device-per-channel-group-per-organisation-per-view-per-day/{organisationUuids}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
