...
/**
 * AnalyticsDataGoalsApiTest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AnalyticsDataGoalsApiTest extends TestCase
{
    ...
    /**
     * Test case for getAnalyticsGoalReportPerCampaignPerDay
     *
     * Return analytics goal report per campaign per day by organisation.
     *
     */
    public function testGetAnalyticsGoalReportPerCampaignPerDay()
    {
    }

    /**
     * Test case for getAnalyticsGoalReportPerChannelGroupPerDay
     *
     * Return analytics goal report per channel group per day by organisation.
     *
     */
    public function testGetAnalyticsGoalReportPerChannelGroupPerDay()
    {
    }

    /**
     * Test case for getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay
     *
     * Return analytics goal report per device per channel group per organisation per view per day.
     *
     */
    public function testGetAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay()
    {
    }

    /**
     * Test case for getAnalyticsGoalReportPerDevicePerDay
     *
     * Return analytics goal report per device per day by organisation.
     *
     */
    public function testGetAnalyticsGoalReportPerDevicePerDay()
    {
    }

    /**
     * Test case for getAnalyticsGoalReportPerSourceMediumPerDay
     *
     * Return analytics goal report per source medium per day by organisation.
     *
     */
    public function testGetAnalyticsGoalReportPerSourceMediumPerDay()
    {
    }
}
